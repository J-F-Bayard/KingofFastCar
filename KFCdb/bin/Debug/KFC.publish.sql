...
GO
PRINT N'Création de [dbo].[Acheteur]...';


GO
CREATE TABLE [dbo].[Acheteur] (
    [idAcheteur] INT           IDENTITY (1, 1) NOT NULL,
    ...
    [actif]      BIT           NOT NULL,
    CONSTRAINT [PK_Acheteur] PRIMARY KEY CLUSTERED ([idAcheteur] ASC),
    CONSTRAINT [UK_Acheteur_Email] UNIQUE NONCLUSTERED ([email] ASC),
    CONSTRAINT [UK_Acheteur_NumCompte] UNIQUE NONCLUSTERED ([numCompte] ASC),
    CONSTRAINT [UK_Acheteur_Telephone] UNIQUE NONCLUSTERED ([telephone] ASC)
);


GO
PRINT N'Création de [dbo].[Dossier]...';
...
CREATE TABLE [dbo].[Dossier] (
    ...
    [prixVente]  INT NULL,
    [actif]      BIT NOT NULL,
    CONSTRAINT [PK_Dossier] PRIMARY KEY CLUSTERED ([idDossier] ASC),
    CONSTRAINT [UK_Dossier_idVoiture] UNIQUE NONCLUSTERED ([idVoiture] ASC)
);
...
CREATE TABLE [dbo].[Equipement] (
    ...
    CONSTRAINT [PK_Equipement] PRIMARY KEY CLUSTERED ([idEquip] ASC),
    CONSTRAINT [UK_Equipement_Nom] UNIQUE NONCLUSTERED ([nom] ASC)
);


GO
PRINT N'Création de [dbo].[Equipement_Installes]...';


GO
CREATE TABLE [dbo].[Equipement_Installes] (
    [idEquipInst] INT IDENTITY (1, 1) NOT NULL,
    [idVoiture]   INT NOT NULL,
    [idEquip]     INT NOT NULL,
    CONSTRAINT [PK_Equipement_Installes] PRIMARY KEY CLUSTERED ([idEquipInst] ASC)
);
...
CREATE TABLE [dbo].[Fournisseur] (
    ...
    [nom]           NVARCHAR (100) NOT NULL,
    [numCompte]     NVARCHAR (100) NOT NULL,
    [tva]           NVARCHAR (100) NOT NULL,
    ...
    [actif]         BIT            NOT NULL,
    CONSTRAINT [PK_Fournisseur] PRIMARY KEY CLUSTERED ([idFournisseur] ASC),
    CONSTRAINT [UK_Fournisseur_email] UNIQUE NONCLUSTERED ([email] ASC),
    CONSTRAINT [UK_Fournisseur_nom] UNIQUE NONCLUSTERED ([nom] ASC),
    CONSTRAINT [UK_Fournisseur_numCompte] UNIQUE NONCLUSTERED ([numCompte] ASC),
    CONSTRAINT [UK_Fournisseur_telephone] UNIQUE NONCLUSTERED ([telephone] ASC),
    CONSTRAINT [UK_Fournisseur_tva] UNIQUE NONCLUSTERED ([tva] ASC)
);


GO
PRINT N'Création de [dbo].[Frais]...';


GO
CREATE TABLE [dbo].[Frais] (
    [idFrais]        INT            IDENTITY (1, 1) NOT NULL,
    ...
    [actif]          BIT            NOT NULL,
    CONSTRAINT [PK_Frais] PRIMARY KEY CLUSTERED ([idFrais] ASC),
    CONSTRAINT [UK_Frais_numFacture] UNIQUE NONCLUSTERED ([numFacture] ASC)
);


GO
PRINT N'Création de [dbo].[Marque]...';
...
CREATE TABLE [dbo].[Marque] (
    ...
    [nom]      NVARCHAR (100) NOT NULL,
    CONSTRAINT [PK_Marque] PRIMARY KEY CLUSTERED ([idMarque] ASC),
    CONSTRAINT [UK_Marque_Nom] UNIQUE NONCLUSTERED ([nom] ASC)
);


GO
PRINT N'Création de [dbo].[Modele]...';
...
CREATE TABLE [dbo].[Modele] (
    ...
    [nom]      NVARCHAR (100) NOT NULL,
    CONSTRAINT [PK_Modele] PRIMARY KEY CLUSTERED ([idModele] ASC)
);
...
GO
PRINT N'Création de [dbo].[Vendeur]...';
...
CREATE TABLE [dbo].[Vendeur] (
    ...
    [numCompte] NVARCHAR (100) NOT NULL,
    [actif]     BIT            NOT NULL,
    CONSTRAINT [PK_Vendeur] PRIMARY KEY CLUSTERED ([idVendeur] ASC),
    CONSTRAINT [UK_Vendeur_email] UNIQUE NONCLUSTERED ([email] ASC),
    CONSTRAINT [UK_Vendeur_numCompte] UNIQUE NONCLUSTERED ([numCompte] ASC),
    CONSTRAINT [UK_Vendeur_telephone] UNIQUE NONCLUSTERED ([telephone] ASC),
    CONSTRAINT [UK_Vendeur_tva] UNIQUE NONCLUSTERED ([tva] ASC)
);


GO
PRINT N'Création de [dbo].[Voiture]...';


GO
CREATE TABLE [dbo].[Voiture] (
    [idVoiture]        INT            IDENTITY (1, 1) NOT NULL,
    [numChassis]       NVARCHAR (100) NOT NULL,
    ...
    [volantGauche]     BIT            NOT NULL,
    [actif]            BIT            NOT NULL,
    CONSTRAINT [PK_Voiture] PRIMARY KEY CLUSTERED ([idVoiture] ASC),
    CONSTRAINT [UK_Voiture_NumChassis] UNIQUE NONCLUSTERED ([numChassis] ASC)
);


GO
PRINT N'Création de contrainte sans nom sur [dbo].[Acheteur]...';


GO
ALTER TABLE [dbo].[Acheteur]
    ADD DEFAULT 1 FOR [actif];


GO
PRINT N'Création de contrainte sans nom sur [dbo].[Dossier]...';


GO
ALTER TABLE [dbo].[Dossier]
    ADD DEFAULT NULL FOR [idAcheteur];
...
GO
ALTER TABLE [dbo].[Dossier]
    ADD DEFAULT NULL FOR [prixVente];
...
GO
PRINT N'Création de contrainte sans nom sur [dbo].[Fournisseur]...';
...
GO
PRINT N'Création de contrainte sans nom sur [dbo].[Frais]...';


GO
ALTER TABLE [dbo].[Frais]
    ADD DEFAULT 1 FOR [actif];


GO
PRINT N'Création de contrainte sans nom sur [dbo].[Vendeur]...';


GO
ALTER TABLE [dbo].[Vendeur]
    ADD DEFAULT 1 FOR [actif];


GO
PRINT N'Création de contrainte sans nom sur [dbo].[Voiture]...';
...
GO
ALTER TABLE [dbo].[Voiture]
    ADD DEFAULT 1 FOR [volantGauche];
...
GO
PRINT N'Création de [dbo].[FK_Dossier_To_Voiture]...';


GO
ALTER TABLE [dbo].[Dossier]
    ADD CONSTRAINT [FK_Dossier_To_Voiture] FOREIGN KEY ([idVoiture]) REFERENCES [dbo].[Voiture] ([idVoiture]);


GO
PRINT N'Création de [dbo].[FK_Dossier_To_Vendeur]...';


GO
ALTER TABLE [dbo].[Dossier]
    ADD CONSTRAINT [FK_Dossier_To_Vendeur] FOREIGN KEY ([idVendeur]) REFERENCES [dbo].[Vendeur] ([idVendeur]);


GO
PRINT N'Création de [dbo].[FK_Dossier_To_Acheteur]...';


GO
ALTER TABLE [dbo].[Dossier]
    ADD CONSTRAINT [FK_Dossier_To_Acheteur] FOREIGN KEY ([idAcheteur]) REFERENCES [dbo].[Acheteur] ([idAcheteur]);


GO
PRINT N'Création de [dbo].[FK_Equipement_Installes_To_Voiture]...';


GO
ALTER TABLE [dbo].[Equipement_Installes]
    ADD CONSTRAINT [FK_Equipement_Installes_To_Voiture] FOREIGN KEY ([idVoiture]) REFERENCES [dbo].[Voiture] ([idVoiture]);


GO
PRINT N'Création de [dbo].[FK_Equipement_Installes_To_Equipement]...';


GO
ALTER TABLE [dbo].[Equipement_Installes]
    ADD CONSTRAINT [FK_Equipement_Installes_To_Equipement] FOREIGN KEY ([idEquip]) REFERENCES [dbo].[Equipement] ([idEquip]);


GO
PRINT N'Création de [dbo].[FK_Frais_To_Fournisseur]...';


GO
ALTER TABLE [dbo].[Frais]
    ADD CONSTRAINT [FK_Frais_To_Fournisseur] FOREIGN KEY ([idFournisseur]) REFERENCES [dbo].[Fournisseur] ([idFournisseur]);


GO
PRINT N'Création de [dbo].[FK_Frais_To_Dossier]...';


GO
ALTER TABLE [dbo].[Frais]
    ADD CONSTRAINT [FK_Frais_To_Dossier] FOREIGN KEY ([idDossier]) REFERENCES [dbo].[Dossier] ([idDossier]);


GO
PRINT N'Création de [dbo].[FK_Modele_To_Marque]...';


GO
ALTER TABLE [dbo].[Modele]
    ADD CONSTRAINT [FK_Modele_To_Marque] FOREIGN KEY ([idMarque]) REFERENCES [dbo].[Marque] ([idMarque]);


GO
PRINT N'Création de [dbo].[FK_Voiture_To_Modele]...';


GO
ALTER TABLE [dbo].[Voiture]
    ADD CONSTRAINT [FK_Voiture_To_Modele] FOREIGN KEY ([idModele]) REFERENCES [dbo].[Modele] ([idModele]);


GO
PRINT N'Création de [dbo].[V_Acheteur]...';
...
CREATE VIEW [dbo].[V_Acheteur]
	AS	SELECT 
		...
		WHERE [actif] = 1
GO
PRINT N'Création de [dbo].[V_Dossier]...';
...
CREATE VIEW [dbo].[V_Dossier]
	AS	SELECT 
		...
		WHERE [actif] = 1
GO
PRINT N'Création de [dbo].[V_Equipement]...';
...
CREATE VIEW [dbo].[V_Equipement]
	AS	SELECT 
		...
		FROM [Equipement]
GO
PRINT N'Création de [dbo].[V_Equipement_Installes]...';
...
GO
PRINT N'Création de [dbo].[V_Fournisseur]...';
...
CREATE VIEW [dbo].[V_Fournisseur]
	AS	SELECT 
		...
		WHERE [actif] = 1
GO
PRINT N'Création de [dbo].[V_Frais]...';
...
CREATE VIEW [dbo].[V_Frais]
	AS	SELECT 
		...
		WHERE [actif] = 1
GO
PRINT N'Création de [dbo].[V_Marque]...';
...
CREATE VIEW [dbo].[V_Marque]
	AS	SELECT 
		...
		FROM [Marque]
GO
PRINT N'Création de [dbo].[V_Modele]...';
...
CREATE VIEW [dbo].[V_User]
	AS SELECT [idUser], [prenom], [nom], [email], [mdp] FROM [User]
GO
PRINT N'Création de [dbo].[V_Vendeur]...';
...
CREATE VIEW [dbo].[V_Vendeur]
	AS	SELECT
		...
		WHERE [actif] = 1
GO
PRINT N'Création de [dbo].[V_Voiture]...';
...
CREATE VIEW [dbo].[V_Voiture]
	AS	SELECT 
		...
		WHERE [actif] = 1
GO
PRINT N'Création de [dbo].[V_Voiture_Details]...';
...
GO
PRINT N'Création de [dbo].[AddAcheteur]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddDossier]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddEquipement]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddEquipementInstalles]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddFournisseur]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddFrais]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddMarque]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddModele]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddVendeur]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[AddVoiture]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[DeleteAcheteur]...';
...
RETURN
GO
PRINT N'Création de [dbo].[DeleteDossier]...';
...
RETURN
GO
PRINT N'Création de [dbo].[DeleteEquipement]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[DeleteEquipementInstalles]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[DeleteFournisseur]...';
...
RETURN
GO
PRINT N'Création de [dbo].[DeleteFrais]...';
...
RETURN
GO
PRINT N'Création de [dbo].[DeleteMarque]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[DeleteModele]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[DeleteVendeur]...';
...
RETURN
GO
PRINT N'Création de [dbo].[DeleteVoiture]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetAcheteur]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetAcheteurById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetAcheteurByName]...';
...
select  idAcheteur as IdBuyer,nom as LastName,prenom as FirstName,email as Email, telephone as Phone ,rue as Street,numero as Number,
		cp as Zip,localite as Locality,pays as Country,numCompte as Account	
	from V_Acheteur where nom like '@LastName%';
RETURN
GO
PRINT N'Création de [dbo].[GetDossier]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetDossierByCarId]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetDossierById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetEquipement]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetEquipementById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetEquipementInstalles]...';


GO
CREATE PROCEDURE [dbo].[GetEquipementInstalles]	
AS
	SELECT idEquip as IdEquipment,idVoiture as IdCar , idEquip as IdEquipment
	from V_Equipement_Installes
RETURN
GO
PRINT N'Création de [dbo].[GetEquipementInstallesById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetEquipementInstallesByIdVoiture]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetFournisseur]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetFournisseurById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetFournisseurByName]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetFrais]...';


GO
CREATE PROCEDURE [dbo].[GetFrais]	
AS
	select idFrais as IdFrais,idFournisseur as IdFournisseur,idDossier as IdDossier,intitule as Entitled, montant as Amount,numFacture as BillNumber,datePrestation as DeliveryDate
	from V_Frais;
RETURN
GO
PRINT N'Création de [dbo].[GetFraisByHistory]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetFraisById]...';
...
CREATE PROCEDURE [dbo].[GetFraisById]
	@IdCharge int
AS
	select idFrais as IdCharge,idFournisseur as IdProvider,idDossier as IdHistory,intitule as Entitled, montant as Amount,numFacture as BillNumber,datePrestation as DeliveryDate
	from V_Frais where idFrais=@IdCharge;
RETURN
GO
PRINT N'Création de [dbo].[GetHash]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[GetLogin]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetMarque]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetMarqueByBrandName]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetMarqueById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetModele]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetModeleByBrandName]...';
...
CREATE PROCEDURE [dbo].[GetModeleByBrandName]
	@BrandName nvarchar(100)
AS
	select idModele as IdModel, Modele.nom as NameBrand, Modele.idMarque as IdBrand
	from Modele join Marque on Modele.idMarque=Marque.idMarque where Marque.nom LIKE '@BrandName%'
RETURN
GO
PRINT N'Création de [dbo].[GetModeleById]...';
...
AS
	select idModele as IdModel,nom as Name,idMarque as IdBrand
	from V_Modele where idModele=@IdModel;
RETURN
GO
PRINT N'Création de [dbo].[GetModeleByModelName]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetUser]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetVendeur]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetVendeurById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetVendeurBySellerName]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetVoiture]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetVoitureByModele]...';


GO
CREATE PROCEDURE [dbo].[GetVoitureByModele]
	@IdCar int
AS
	SELECT idVoiture as IdCar, 
			numChassis as ChassisNumber, 
...
RETURN
GO
PRINT N'Création de [dbo].[GetVoitureDetails]...';


GO
CREATE PROCEDURE [dbo].[GetVoitureDetails]
AS
	SELECT * FROM V_Voiture_Details
RETURN
GO
PRINT N'Création de [dbo].[GetVoitureDetailsById]...';
...
RETURN
GO
PRINT N'Création de [dbo].[GetVoitureDetailsByModele]...';
...
RETURN
GO
PRINT N'Création de [dbo].[UpdateAcheteur]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateDossier]...';
...
CREATE PROCEDURE [dbo].[UpdateDossier]
	...
	@SoldPrice int
AS
	UPDATE Dossier set idVoiture=@IdCar,idVendeur=@IdSeller,idAcheteur=@IdBuyer,prixAchat=@BuyPrice,prixVente=@SoldPrice
	where idDossier=@Idhistory;
	
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateEquipement]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateEquipementInstalles]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateFournisseur]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateFrais]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateMarque]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateModel]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateVendeur]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[UpdateVoiture]...';
...
RETURN 0
GO
PRINT N'Création de [dbo].[CheckLogin]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9633a779-7eed-4768-80ab-f1bd9342fbe8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9633a779-7eed-4768-80ab-f1bd9342fbe8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd1ef8c58-c877-41f3-a910-a8b44b221ab6')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d1ef8c58-c877-41f3-a910-a8b44b221ab6')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '10066beb-6e05-4eab-8edf-370a648bdd01')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('10066beb-6e05-4eab-8edf-370a648bdd01')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4084452d-763f-4014-a792-e4b072d14898')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4084452d-763f-4014-a792-e4b072d14898')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '09a8728c-7e55-4d4a-8911-a4caf134b805')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('09a8728c-7e55-4d4a-8911-a4caf134b805')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '664e6f54-e786-4b7e-affb-cbd8fca91386')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('664e6f54-e786-4b7e-affb-cbd8fca91386')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '3a73584d-42a4-4ca8-bdef-948c5f50be21')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('3a73584d-42a4-4ca8-bdef-948c5f50be21')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'f1a8a2e2-96c9-497f-aef9-98a903a64ff5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('f1a8a2e2-96c9-497f-aef9-98a903a64ff5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'eeba017a-0ff5-464b-b661-bcf9393ff035')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('eeba017a-0ff5-464b-b661-bcf9393ff035')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd37586ef-c5e0-4534-aa63-a25a6b0a5225')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d37586ef-c5e0-4534-aa63-a25a6b0a5225')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a44487c5-348b-4442-9452-4c7faecc3884')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a44487c5-348b-4442-9452-4c7faecc3884')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9d348e71-3354-4442-9ce9-de2578b1ef74')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9d348e71-3354-4442-9ce9-de2578b1ef74')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '45bd00e8-c6e4-4df8-9564-7d9adda0e499')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('45bd00e8-c6e4-4df8-9564-7d9adda0e499')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd266f913-2ac9-4390-b8f9-f34f2bd8ce04')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d266f913-2ac9-4390-b8f9-f34f2bd8ce04')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '09dc1c1b-bf45-441d-b1a4-f50494d8fb5b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('09dc1c1b-bf45-441d-b1a4-f50494d8fb5b')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '18814088-12e8-4ee1-b404-215db876dad6')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('18814088-12e8-4ee1-b404-215db876dad6')
